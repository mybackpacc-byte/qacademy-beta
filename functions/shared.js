// functions/shared.js
// All shared helpers used by app.js, exams.js, and question-bank.js
...
<style>
  ...
  input,select,textarea{width:100%;padding:10px;border:1px solid rgba(0,0,0,.14);border-radius:10px;box-sizing:border-box;font-family:inherit}
