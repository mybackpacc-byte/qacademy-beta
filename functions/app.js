// functions/app.js
// User, auth, school, and admin routes
// Exam routes live in exams.js

import { createHelpers } from "./shared.js";

export async function handleAppRequest(ctx) {
  try {
    ...
    if (path === "/teacher") {
      ...
      // Load exams for this teacher across their courses
      ...
      const examRows = exams.map((e) => `
        <tr>
          ...
          <td class="small">
            <span class="pill">${escapeHtml(e.status)}</span>
          </td>
          <td class="small">
